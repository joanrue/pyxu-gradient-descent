...
def pkg_info() -> cabc.Mapping:
    ...
    """
    sphinx_src_dir = plib.Path(__file__).parent
    info_path = sphinx_src_dir / ".." / "src" / "pyxu_gradient_descent.egg-info" / "PKG-INFO"
...
html_theme_options = {
    ...
    "icon_links": [
        ...
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/pyxu_gradient_descent/",
...
html_context = {
    "github_user": "joanrue",
    "github_repo": "https://github.com/joanrue/pyxu-gradient-descent",
    "github_version": "main",
    "doc_path": "doc",
    "default_mode": "light",
}
